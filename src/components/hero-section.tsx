    ...
    <>
      ...
      <section className='relative mt-32 w-full'>
        ...
        <Image
          ...
          width={2560}
          height={699}
          className='min-h-[70vh] max-w-full object-center opacity-80 md:aspect-[16/9] md:h-[75vh] md:max-w-full'
          priority={true}
        />
        ...
        <div className='absolute inset-0 mx-2 my-4 flex max-h-[489px] max-w-[600px] flex-col items-center rounded-lg bg-[#E0E0E0F5] px-4 pt-18 md:mx-auto md:my-auto md:px-20'>
          <h2 className='py-4 text-5xl font-extrabold tracking-tight drop-shadow-lg md:text-6xl'>
            WELCOME
          </h2>
          <p className='mt-4 text-center text-xl drop-shadow'>
